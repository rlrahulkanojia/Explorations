...
def encode_pdf(path, embeddings, chunk_size=1000, chunk_overlap=200):
    """
...
def init_azure_openai_model(api_key, api_version, endpoint, deployment_name):
...
def init_azure_openai_embeddings(api_key, api_version, endpoint, model_id="text-embedding-3-small"):
